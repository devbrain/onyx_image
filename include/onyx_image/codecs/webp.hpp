#ifndef ONYX_IMAGE_CODECS_WEBP_HPP_
#define ONYX_IMAGE_CODECS_WEBP_HPP_
...
class ONYX_IMAGE_EXPORT webp_decoder {
public:
    static constexpr std::string_view name = "webp";
    static constexpr std::string_view extensions[] = {".webp"};
...
#endif // ONYX_IMAGE_CODECS_WEBP_HPP_
